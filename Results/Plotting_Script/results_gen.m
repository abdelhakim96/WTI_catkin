...
M_VT_wind = dlmread('/home/airlab/hakim_ws/src/WTI_catkin/Results/Data/5ms/VTMPC.txt');
...
plot3(M_VT_wind(600:end-16000,5),M_VT_wind(600:end-16000,6),M_VT_wind(600:end-16000,7),'k', 'LineWidth', 4,'color',color_VTNMPC_nw);
hold on
...
plot3(M_NMPC_wind(5000:end-11400,5),M_NMPC_wind(5000:end-11400,6),M_NMPC_wind(5000:end-11400,7),'k', 'LineWidth', 4,'color',color_NMPC);

hold on

plot3(M_PAMPC_wind(600:end-100,5),M_PAMPC_wind(600:end-100,6),M_PAMPC_wind(600:end-100,7),'k', 'LineWidth', 4,'color',color_PAMPC);
...
hold on
plot ([1:length(d_NMPC_w)-5000]/50,d_NMPC_w(5000:end-1),'LineWidth', 3,'color',color_NMPC)
...
%hold on 
plot ([1: length(s_i_vt)-600]/50,s_i_vt(600:end-1),'LineWidth', 3, 'Color',color_VTNMPC_nw)
...
hold on
plot ([1: length(s_i_nmpc)-5000]/50,s_i_nmpc(5000:end-1),'LineWidth', 3,'Color',color_NMPC)

hold on

plot ([1: length(s_i_pampc)-600]/50,s_i_pampc(600:end-1),'LineWidth', 3,'Color',color_PAMPC)
...
hold on
plot ([1: length( o_vt_w)-600]/50, (1-o_vt_w(600:end-1)/7),'LineWidth', 3,'Color',color_VTNMPC_nw)
...
hold on 
plot ([1: length(o_nmpc_w)-5000]/50,(1-o_nmpc_w(5000:end-1)/7),'LineWidth', 3,'Color',color_NMPC)
hold on
plot ([1: length(o_pampc_w)-600]/50,(1-o_pampc_w(600:end-1)/7),'LineWidth', 3,'Color',color_PAMPC)

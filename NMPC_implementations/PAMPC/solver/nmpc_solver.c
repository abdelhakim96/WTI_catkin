...
a[2] = (sqrt(((a[1]*a[1])+(real_t)(1.0000000000000001e-01))));
...
a[7] = (1.0/sqrt(((a[1]*a[1])+(real_t)(1.0000000000000001e-01))));
...
a[30] = ((real_t)(1.0000000000000000e+00)/(a[1]+(real_t)(1.0000000000000001e-01)));
...
out[9] = xd[9];
out[10] = (a[0]/a[2]);
out[11] = (a[3]/(a[1]+(real_t)(1.0000000000000001e-01)));
out[12] = u[0];
out[13] = u[1];
out[14] = u[2];
out[15] = u[3];

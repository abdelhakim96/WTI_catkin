...
a[0] = (((((((xd[6]*xd[6])+(xd[4]*((real_t)(0.0000000000000000e+00)-xd[4])))+(xd[5]*((real_t)(0.0000000000000000e+00)-xd[5])))+(xd[3]*xd[3]))*(od[3]-xd[0]))+(((((xd[6]*xd[5])+(xd[6]*xd[5]))+(xd[4]*xd[3]))+(((real_t)(0.0000000000000000e+00)-xd[4])*((real_t)(0.0000000000000000e+00)-xd[3])))*(od[4]-xd[1])))+(((((xd[6]*((real_t)(0.0000000000000000e+00)-xd[4]))+(xd[6]*((real_t)(0.0000000000000000e+00)-xd[4])))+(xd[5]*xd[3]))+(xd[5]*xd[3]))*(od[5]-xd[2])));
a[1] = (((((((xd[6]*xd[6])+(xd[4]*((real_t)(0.0000000000000000e+00)-xd[4])))+(xd[5]*xd[5]))+(xd[3]*((real_t)(0.0000000000000000e+00)-xd[3])))*(od[5]-xd[2]))+(((((xd[6]*xd[4])+(xd[6]*xd[4]))+(xd[5]*xd[3]))+(((real_t)(0.0000000000000000e+00)-xd[5])*((real_t)(0.0000000000000000e+00)-xd[3])))*(od[3]-xd[0])))+(((((xd[6]*((real_t)(0.0000000000000000e+00)-xd[3]))+(xd[6]*((real_t)(0.0000000000000000e+00)-xd[3])))+(xd[4]*xd[5]))+(xd[4]*xd[5]))*(od[4]-xd[1])));
a[2] = (((((((xd[6]*xd[6])+(xd[4]*xd[4]))+(xd[5]*((real_t)(0.0000000000000000e+00)-xd[5])))+(xd[3]*((real_t)(0.0000000000000000e+00)-xd[3])))*(od[4]-xd[1]))+(((((xd[6]*xd[3])+(xd[6]*xd[3]))+(xd[4]*xd[5]))+(((real_t)(0.0000000000000000e+00)-xd[4])*((real_t)(0.0000000000000000e+00)-xd[5])))*(od[5]-xd[2])))+(((((xd[6]*((real_t)(0.0000000000000000e+00)-xd[5]))+(xd[6]*((real_t)(0.0000000000000000e+00)-xd[5])))+(xd[4]*xd[3]))+(xd[4]*xd[3]))*(od[3]-xd[0])));
a[3] = (((((xd[6]*xd[6])+(xd[4]*((real_t)(0.0000000000000000e+00)-xd[4])))+(xd[5]*((real_t)(0.0000000000000000e+00)-xd[5])))+(xd[3]*xd[3]))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[4] = ((real_t)(1.0000000000000000e+00)/(a[1]+(real_t)(1.0000000000000001e-01)));
a[5] = (((((xd[6]*xd[4])+(xd[6]*xd[4]))+(xd[5]*xd[3]))+(((real_t)(0.0000000000000000e+00)-xd[5])*((real_t)(0.0000000000000000e+00)-xd[3])))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[6] = (a[4]*a[4]);
a[7] = (((((xd[6]*xd[5])+(xd[6]*xd[5]))+(xd[4]*xd[3]))+(((real_t)(0.0000000000000000e+00)-xd[4])*((real_t)(0.0000000000000000e+00)-xd[3])))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[8] = (((((xd[6]*((real_t)(0.0000000000000000e+00)-xd[3]))+(xd[6]*((real_t)(0.0000000000000000e+00)-xd[3])))+(xd[4]*xd[5]))+(xd[4]*xd[5]))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[9] = (((((xd[6]*((real_t)(0.0000000000000000e+00)-xd[4]))+(xd[6]*((real_t)(0.0000000000000000e+00)-xd[4])))+(xd[5]*xd[3]))+(xd[5]*xd[3]))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[10] = (((((xd[6]*xd[6])+(xd[4]*((real_t)(0.0000000000000000e+00)-xd[4])))+(xd[5]*xd[5]))+(xd[3]*((real_t)(0.0000000000000000e+00)-xd[3])))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[11] = ((((xd[3]+xd[3])*(od[3]-xd[0]))+((xd[4]+(((real_t)(0.0000000000000000e+00)-xd[4])*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[4]-xd[1])))+((xd[5]+xd[5])*(od[5]-xd[2])));
a[12] = ((((((real_t)(0.0000000000000000e+00)-xd[3])+(xd[3]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[5]-xd[2]))+((xd[5]+(((real_t)(0.0000000000000000e+00)-xd[5])*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[3]-xd[0])))+(((xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)))+(xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[4]-xd[1])));
a[13] = ((((((real_t)(0.0000000000000000e+00)-xd[4])+(xd[4]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[3]-xd[0]))+((xd[3]+(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*((real_t)(0.0000000000000000e+00)-xd[3])))*(od[4]-xd[1])))+(((xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)))+(xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[5]-xd[2])));
a[14] = ((((((real_t)(0.0000000000000000e+00)-xd[4])+(xd[4]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[5]-xd[2]))+((xd[6]+xd[6])*(od[3]-xd[0])))+((xd[5]+xd[5])*(od[4]-xd[1])));
a[15] = ((((((real_t)(0.0000000000000000e+00)-xd[5])+(xd[5]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[3]-xd[0]))+((xd[6]+xd[6])*(od[4]-xd[1])))+((xd[3]+xd[3])*(od[5]-xd[2])));
a[16] = ((((xd[5]+xd[5])*(od[5]-xd[2]))+((xd[3]+(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*((real_t)(0.0000000000000000e+00)-xd[3])))*(od[3]-xd[0])))+((xd[4]+xd[4])*(od[4]-xd[1])));
a[17] = ((((xd[6]+xd[6])*(od[3]-xd[0]))+((xd[5]+xd[5])*(od[4]-xd[1])))+((((real_t)(0.0000000000000000e+00)-xd[4])+((real_t)(0.0000000000000000e+00)-xd[4]))*(od[5]-xd[2])));
a[18] = ((((xd[6]+xd[6])*(od[5]-xd[2]))+((xd[4]+xd[4])*(od[3]-xd[0])))+((((real_t)(0.0000000000000000e+00)-xd[3])+((real_t)(0.0000000000000000e+00)-xd[3]))*(od[4]-xd[1])));
a[19] = (((((xd[6]*((real_t)(0.0000000000000000e+00)-xd[5]))+(xd[6]*((real_t)(0.0000000000000000e+00)-xd[5])))+(xd[4]*xd[3]))+(xd[4]*xd[3]))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[20] = ((real_t)(1.0000000000000000e+00)/(a[1]+(real_t)(1.0000000000000001e-01)));
a[21] = (((((xd[6]*xd[4])+(xd[6]*xd[4]))+(xd[5]*xd[3]))+(((real_t)(0.0000000000000000e+00)-xd[5])*((real_t)(0.0000000000000000e+00)-xd[3])))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[22] = (a[20]*a[20]);
a[23] = (((((xd[6]*xd[6])+(xd[4]*xd[4]))+(xd[5]*((real_t)(0.0000000000000000e+00)-xd[5])))+(xd[3]*((real_t)(0.0000000000000000e+00)-xd[3])))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[24] = (((((xd[6]*((real_t)(0.0000000000000000e+00)-xd[3]))+(xd[6]*((real_t)(0.0000000000000000e+00)-xd[3])))+(xd[4]*xd[5]))+(xd[4]*xd[5]))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[25] = (((((xd[6]*xd[3])+(xd[6]*xd[3]))+(xd[4]*xd[5]))+(((real_t)(0.0000000000000000e+00)-xd[4])*((real_t)(0.0000000000000000e+00)-xd[5])))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[26] = (((((xd[6]*xd[6])+(xd[4]*((real_t)(0.0000000000000000e+00)-xd[4])))+(xd[5]*xd[5]))+(xd[3]*((real_t)(0.0000000000000000e+00)-xd[3])))*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)));
a[27] = ((((((real_t)(0.0000000000000000e+00)-xd[3])+(xd[3]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[4]-xd[1]))+((xd[6]+xd[6])*(od[5]-xd[2])))+((xd[4]+xd[4])*(od[3]-xd[0])));
a[28] = ((((((real_t)(0.0000000000000000e+00)-xd[3])+(xd[3]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[5]-xd[2]))+((xd[5]+(((real_t)(0.0000000000000000e+00)-xd[5])*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[3]-xd[0])))+(((xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)))+(xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[4]-xd[1])));
a[29] = ((((xd[4]+xd[4])*(od[4]-xd[1]))+((xd[5]+(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*((real_t)(0.0000000000000000e+00)-xd[5])))*(od[5]-xd[2])))+((xd[3]+xd[3])*(od[3]-xd[0])));
a[30] = ((((((real_t)(0.0000000000000000e+00)-xd[4])+(xd[4]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[5]-xd[2]))+((xd[6]+xd[6])*(od[3]-xd[0])))+((xd[5]+xd[5])*(od[4]-xd[1])));
a[31] = ((((((real_t)(0.0000000000000000e+00)-xd[5])+(xd[5]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[4]-xd[1]))+((xd[4]+(((real_t)(0.0000000000000000e+00)-xd[4])*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[5]-xd[2])))+(((xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)))+(xd[6]*((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))))*(od[3]-xd[0])));
a[32] = ((((xd[5]+xd[5])*(od[5]-xd[2]))+((xd[3]+(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*((real_t)(0.0000000000000000e+00)-xd[3])))*(od[3]-xd[0])))+((xd[4]+xd[4])*(od[4]-xd[1])));
a[33] = ((((xd[6]+xd[6])*(od[4]-xd[1]))+((xd[3]+xd[3])*(od[5]-xd[2])))+((((real_t)(0.0000000000000000e+00)-xd[5])+((real_t)(0.0000000000000000e+00)-xd[5]))*(od[3]-xd[0])));
a[34] = ((((xd[6]+xd[6])*(od[5]-xd[2]))+((xd[4]+xd[4])*(od[3]-xd[0])))+((((real_t)(0.0000000000000000e+00)-xd[3])+((real_t)(0.0000000000000000e+00)-xd[3]))*(od[4]-xd[1])));
...
out[146] = ((a[3]*a[4])-((a[0]*a[5])*a[6]));
out[147] = ((a[7]*a[4])-((a[0]*a[8])*a[6]));
out[148] = ((a[9]*a[4])-((a[0]*a[10])*a[6]));
out[149] = ((a[11]*a[4])-((a[0]*a[12])*a[6]));
out[150] = ((a[13]*a[4])-((a[0]*a[14])*a[6]));
out[151] = ((a[15]*a[4])-((a[0]*a[16])*a[6]));
out[152] = ((a[17]*a[4])-((a[0]*a[18])*a[6]));
...
out[159] = ((a[19]*a[20])-((a[2]*a[21])*a[22]));
out[160] = ((a[23]*a[20])-((a[2]*a[24])*a[22]));
out[161] = ((a[25]*a[20])-((a[2]*a[26])*a[22]));
out[162] = ((a[27]*a[20])-((a[2]*a[28])*a[22]));
out[163] = ((a[29]*a[20])-((a[2]*a[30])*a[22]));
out[164] = ((a[31]*a[20])-((a[2]*a[32])*a[22]));
out[165] = ((a[33]*a[20])-((a[2]*a[34])*a[22]));

...
a[36] = (((real_t)(1.0000000000000000e+00)/a[3])*((((real_t)(0.0000000000000000e+00)-(((a[33]*a[7])*a[8])*a[0]))+(((a[11]*a[34])*a[13])*a[1]))-((a[35]*a[15])*a[2])));
a[37] = ((real_t)(-1.0000000000000000e+00)*(sin(u[1])));
a[38] = (cos(u[1]));
a[39] = ((real_t)(-1.0000000000000000e+00)*(sin(u[1])));
a[40] = (cos(u[1]));
a[41] = (cos(u[1]));
a[42] = (((real_t)(1.0000000000000000e+00)/a[3])*(((((a[4]*a[37])-(((a[6]*a[7])*a[38])*a[0]))-(a[39]*a[10]))+(((a[11]*a[12])*a[40])*a[1]))-((a[14]*a[41])*a[2])));
a[43] = ((real_t)(-1.0000000000000000e+00)*(sin(u[2])));
a[44] = (cos(u[2]));
a[45] = (cos(u[2]));
a[46] = ((real_t)(-1.0000000000000000e+00)*(sin(u[2])));
a[47] = (((real_t)(1.0000000000000000e+00)/a[3])*((((a[43]*a[5])-(((a[6]*a[44])*a[8])*a[0]))-(a[9]*a[45]))+(((a[46]*a[12])*a[13])*a[1])));
...
{
tmpQ2[0] = + tmpFx[0]*tmpObjS[0] + tmpFx[6]*tmpObjS[11] + tmpFx[12]*tmpObjS[22] + tmpFx[18]*tmpObjS[33] + tmpFx[24]*tmpObjS[44] + tmpFx[30]*tmpObjS[55] + tmpFx[36]*tmpObjS[66] + tmpFx[42]*tmpObjS[77] + tmpFx[48]*tmpObjS[88] + tmpFx[54]*tmpObjS[99] + tmpFx[60]*tmpObjS[110];
tmpQ2[1] = + tmpFx[0]*tmpObjS[1] + tmpFx[6]*tmpObjS[12] + tmpFx[12]*tmpObjS[23] + tmpFx[18]*tmpObjS[34] + tmpFx[24]*tmpObjS[45] + tmpFx[30]*tmpObjS[56] + tmpFx[36]*tmpObjS[67] + tmpFx[42]*tmpObjS[78] + tmpFx[48]*tmpObjS[89] + tmpFx[54]*tmpObjS[100] + tmpFx[60]*tmpObjS[111];
tmpQ2[2] = + tmpFx[0]*tmpObjS[2] + tmpFx[6]*tmpObjS[13] + tmpFx[12]*tmpObjS[24] + tmpFx[18]*tmpObjS[35] + tmpFx[24]*tmpObjS[46] + tmpFx[30]*tmpObjS[57] + tmpFx[36]*tmpObjS[68] + tmpFx[42]*tmpObjS[79] + tmpFx[48]*tmpObjS[90] + tmpFx[54]*tmpObjS[101] + tmpFx[60]*tmpObjS[112];
tmpQ2[3] = + tmpFx[0]*tmpObjS[3] + tmpFx[6]*tmpObjS[14] + tmpFx[12]*tmpObjS[25] + tmpFx[18]*tmpObjS[36] + tmpFx[24]*tmpObjS[47] + tmpFx[30]*tmpObjS[58] + tmpFx[36]*tmpObjS[69] + tmpFx[42]*tmpObjS[80] + tmpFx[48]*tmpObjS[91] + tmpFx[54]*tmpObjS[102] + tmpFx[60]*tmpObjS[113];
tmpQ2[4] = + tmpFx[0]*tmpObjS[4] + tmpFx[6]*tmpObjS[15] + tmpFx[12]*tmpObjS[26] + tmpFx[18]*tmpObjS[37] + tmpFx[24]*tmpObjS[48] + tmpFx[30]*tmpObjS[59] + tmpFx[36]*tmpObjS[70] + tmpFx[42]*tmpObjS[81] + tmpFx[48]*tmpObjS[92] + tmpFx[54]*tmpObjS[103] + tmpFx[60]*tmpObjS[114];
tmpQ2[5] = + tmpFx[0]*tmpObjS[5] + tmpFx[6]*tmpObjS[16] + tmpFx[12]*tmpObjS[27] + tmpFx[18]*tmpObjS[38] + tmpFx[24]*tmpObjS[49] + tmpFx[30]*tmpObjS[60] + tmpFx[36]*tmpObjS[71] + tmpFx[42]*tmpObjS[82] + tmpFx[48]*tmpObjS[93] + tmpFx[54]*tmpObjS[104] + tmpFx[60]*tmpObjS[115];
tmpQ2[6] = + tmpFx[0]*tmpObjS[6] + tmpFx[6]*tmpObjS[17] + tmpFx[12]*tmpObjS[28] + tmpFx[18]*tmpObjS[39] + tmpFx[24]*tmpObjS[50] + tmpFx[30]*tmpObjS[61] + tmpFx[36]*tmpObjS[72] + tmpFx[42]*tmpObjS[83] + tmpFx[48]*tmpObjS[94] + tmpFx[54]*tmpObjS[105] + tmpFx[60]*tmpObjS[116];
tmpQ2[7] = + tmpFx[0]*tmpObjS[7] + tmpFx[6]*tmpObjS[18] + tmpFx[12]*tmpObjS[29] + tmpFx[18]*tmpObjS[40] + tmpFx[24]*tmpObjS[51] + tmpFx[30]*tmpObjS[62] + tmpFx[36]*tmpObjS[73] + tmpFx[42]*tmpObjS[84] + tmpFx[48]*tmpObjS[95] + tmpFx[54]*tmpObjS[106] + tmpFx[60]*tmpObjS[117];
tmpQ2[8] = + tmpFx[0]*tmpObjS[8] + tmpFx[6]*tmpObjS[19] + tmpFx[12]*tmpObjS[30] + tmpFx[18]*tmpObjS[41] + tmpFx[24]*tmpObjS[52] + tmpFx[30]*tmpObjS[63] + tmpFx[36]*tmpObjS[74] + tmpFx[42]*tmpObjS[85] + tmpFx[48]*tmpObjS[96] + tmpFx[54]*tmpObjS[107] + tmpFx[60]*tmpObjS[118];
tmpQ2[9] = + tmpFx[0]*tmpObjS[9] + tmpFx[6]*tmpObjS[20] + tmpFx[12]*tmpObjS[31] + tmpFx[18]*tmpObjS[42] + tmpFx[24]*tmpObjS[53] + tmpFx[30]*tmpObjS[64] + tmpFx[36]*tmpObjS[75] + tmpFx[42]*tmpObjS[86] + tmpFx[48]*tmpObjS[97] + tmpFx[54]*tmpObjS[108] + tmpFx[60]*tmpObjS[119];
tmpQ2[10] = + tmpFx[0]*tmpObjS[10] + tmpFx[6]*tmpObjS[21] + tmpFx[12]*tmpObjS[32] + tmpFx[18]*tmpObjS[43] + tmpFx[24]*tmpObjS[54] + tmpFx[30]*tmpObjS[65] + tmpFx[36]*tmpObjS[76] + tmpFx[42]*tmpObjS[87] + tmpFx[48]*tmpObjS[98] + tmpFx[54]*tmpObjS[109] + tmpFx[60]*tmpObjS[120];
tmpQ2[11] = + tmpFx[1]*tmpObjS[0] + tmpFx[7]*tmpObjS[11] + tmpFx[13]*tmpObjS[22] + tmpFx[19]*tmpObjS[33] + tmpFx[25]*tmpObjS[44] + tmpFx[31]*tmpObjS[55] + tmpFx[37]*tmpObjS[66] + tmpFx[43]*tmpObjS[77] + tmpFx[49]*tmpObjS[88] + tmpFx[55]*tmpObjS[99] + tmpFx[61]*tmpObjS[110];
tmpQ2[12] = + tmpFx[1]*tmpObjS[1] + tmpFx[7]*tmpObjS[12] + tmpFx[13]*tmpObjS[23] + tmpFx[19]*tmpObjS[34] + tmpFx[25]*tmpObjS[45] + tmpFx[31]*tmpObjS[56] + tmpFx[37]*tmpObjS[67] + tmpFx[43]*tmpObjS[78] + tmpFx[49]*tmpObjS[89] + tmpFx[55]*tmpObjS[100] + tmpFx[61]*tmpObjS[111];
tmpQ2[13] = + tmpFx[1]*tmpObjS[2] + tmpFx[7]*tmpObjS[13] + tmpFx[13]*tmpObjS[24] + tmpFx[19]*tmpObjS[35] + tmpFx[25]*tmpObjS[46] + tmpFx[31]*tmpObjS[57] + tmpFx[37]*tmpObjS[68] + tmpFx[43]*tmpObjS[79] + tmpFx[49]*tmpObjS[90] + tmpFx[55]*tmpObjS[101] + tmpFx[61]*tmpObjS[112];
tmpQ2[14] = + tmpFx[1]*tmpObjS[3] + tmpFx[7]*tmpObjS[14] + tmpFx[13]*tmpObjS[25] + tmpFx[19]*tmpObjS[36] + tmpFx[25]*tmpObjS[47] + tmpFx[31]*tmpObjS[58] + tmpFx[37]*tmpObjS[69] + tmpFx[43]*tmpObjS[80] + tmpFx[49]*tmpObjS[91] + tmpFx[55]*tmpObjS[102] + tmpFx[61]*tmpObjS[113];
tmpQ2[15] = + tmpFx[1]*tmpObjS[4] + tmpFx[7]*tmpObjS[15] + tmpFx[13]*tmpObjS[26] + tmpFx[19]*tmpObjS[37] + tmpFx[25]*tmpObjS[48] + tmpFx[31]*tmpObjS[59] + tmpFx[37]*tmpObjS[70] + tmpFx[43]*tmpObjS[81] + tmpFx[49]*tmpObjS[92] + tmpFx[55]*tmpObjS[103] + tmpFx[61]*tmpObjS[114];
tmpQ2[16] = + tmpFx[1]*tmpObjS[5] + tmpFx[7]*tmpObjS[16] + tmpFx[13]*tmpObjS[27] + tmpFx[19]*tmpObjS[38] + tmpFx[25]*tmpObjS[49] + tmpFx[31]*tmpObjS[60] + tmpFx[37]*tmpObjS[71] + tmpFx[43]*tmpObjS[82] + tmpFx[49]*tmpObjS[93] + tmpFx[55]*tmpObjS[104] + tmpFx[61]*tmpObjS[115];
tmpQ2[17] = + tmpFx[1]*tmpObjS[6] + tmpFx[7]*tmpObjS[17] + tmpFx[13]*tmpObjS[28] + tmpFx[19]*tmpObjS[39] + tmpFx[25]*tmpObjS[50] + tmpFx[31]*tmpObjS[61] + tmpFx[37]*tmpObjS[72] + tmpFx[43]*tmpObjS[83] + tmpFx[49]*tmpObjS[94] + tmpFx[55]*tmpObjS[105] + tmpFx[61]*tmpObjS[116];
tmpQ2[18] = + tmpFx[1]*tmpObjS[7] + tmpFx[7]*tmpObjS[18] + tmpFx[13]*tmpObjS[29] + tmpFx[19]*tmpObjS[40] + tmpFx[25]*tmpObjS[51] + tmpFx[31]*tmpObjS[62] + tmpFx[37]*tmpObjS[73] + tmpFx[43]*tmpObjS[84] + tmpFx[49]*tmpObjS[95] + tmpFx[55]*tmpObjS[106] + tmpFx[61]*tmpObjS[117];
tmpQ2[19] = + tmpFx[1]*tmpObjS[8] + tmpFx[7]*tmpObjS[19] + tmpFx[13]*tmpObjS[30] + tmpFx[19]*tmpObjS[41] + tmpFx[25]*tmpObjS[52] + tmpFx[31]*tmpObjS[63] + tmpFx[37]*tmpObjS[74] + tmpFx[43]*tmpObjS[85] + tmpFx[49]*tmpObjS[96] + tmpFx[55]*tmpObjS[107] + tmpFx[61]*tmpObjS[118];
tmpQ2[20] = + tmpFx[1]*tmpObjS[9] + tmpFx[7]*tmpObjS[20] + tmpFx[13]*tmpObjS[31] + tmpFx[19]*tmpObjS[42] + tmpFx[25]*tmpObjS[53] + tmpFx[31]*tmpObjS[64] + tmpFx[37]*tmpObjS[75] + tmpFx[43]*tmpObjS[86] + tmpFx[49]*tmpObjS[97] + tmpFx[55]*tmpObjS[108] + tmpFx[61]*tmpObjS[119];
tmpQ2[21] = + tmpFx[1]*tmpObjS[10] + tmpFx[7]*tmpObjS[21] + tmpFx[13]*tmpObjS[32] + tmpFx[19]*tmpObjS[43] + tmpFx[25]*tmpObjS[54] + tmpFx[31]*tmpObjS[65] + tmpFx[37]*tmpObjS[76] + tmpFx[43]*tmpObjS[87] + tmpFx[49]*tmpObjS[98] + tmpFx[55]*tmpObjS[109] + tmpFx[61]*tmpObjS[120];
tmpQ2[22] = + tmpFx[2]*tmpObjS[0] + tmpFx[8]*tmpObjS[11] + tmpFx[14]*tmpObjS[22] + tmpFx[20]*tmpObjS[33] + tmpFx[26]*tmpObjS[44] + tmpFx[32]*tmpObjS[55] + tmpFx[38]*tmpObjS[66] + tmpFx[44]*tmpObjS[77] + tmpFx[50]*tmpObjS[88] + tmpFx[56]*tmpObjS[99] + tmpFx[62]*tmpObjS[110];
tmpQ2[23] = + tmpFx[2]*tmpObjS[1] + tmpFx[8]*tmpObjS[12] + tmpFx[14]*tmpObjS[23] + tmpFx[20]*tmpObjS[34] + tmpFx[26]*tmpObjS[45] + tmpFx[32]*tmpObjS[56] + tmpFx[38]*tmpObjS[67] + tmpFx[44]*tmpObjS[78] + tmpFx[50]*tmpObjS[89] + tmpFx[56]*tmpObjS[100] + tmpFx[62]*tmpObjS[111];
tmpQ2[24] = + tmpFx[2]*tmpObjS[2] + tmpFx[8]*tmpObjS[13] + tmpFx[14]*tmpObjS[24] + tmpFx[20]*tmpObjS[35] + tmpFx[26]*tmpObjS[46] + tmpFx[32]*tmpObjS[57] + tmpFx[38]*tmpObjS[68] + tmpFx[44]*tmpObjS[79] + tmpFx[50]*tmpObjS[90] + tmpFx[56]*tmpObjS[101] + tmpFx[62]*tmpObjS[112];
tmpQ2[25] = + tmpFx[2]*tmpObjS[3] + tmpFx[8]*tmpObjS[14] + tmpFx[14]*tmpObjS[25] + tmpFx[20]*tmpObjS[36] + tmpFx[26]*tmpObjS[47] + tmpFx[32]*tmpObjS[58] + tmpFx[38]*tmpObjS[69] + tmpFx[44]*tmpObjS[80] + tmpFx[50]*tmpObjS[91] + tmpFx[56]*tmpObjS[102] + tmpFx[62]*tmpObjS[113];
tmpQ2[26] = + tmpFx[2]*tmpObjS[4] + tmpFx[8]*tmpObjS[15] + tmpFx[14]*tmpObjS[26] + tmpFx[20]*tmpObjS[37] + tmpFx[26]*tmpObjS[48] + tmpFx[32]*tmpObjS[59] + tmpFx[38]*tmpObjS[70] + tmpFx[44]*tmpObjS[81] + tmpFx[50]*tmpObjS[92] + tmpFx[56]*tmpObjS[103] + tmpFx[62]*tmpObjS[114];
tmpQ2[27] = + tmpFx[2]*tmpObjS[5] + tmpFx[8]*tmpObjS[16] + tmpFx[14]*tmpObjS[27] + tmpFx[20]*tmpObjS[38] + tmpFx[26]*tmpObjS[49] + tmpFx[32]*tmpObjS[60] + tmpFx[38]*tmpObjS[71] + tmpFx[44]*tmpObjS[82] + tmpFx[50]*tmpObjS[93] + tmpFx[56]*tmpObjS[104] + tmpFx[62]*tmpObjS[115];
tmpQ2[28] = + tmpFx[2]*tmpObjS[6] + tmpFx[8]*tmpObjS[17] + tmpFx[14]*tmpObjS[28] + tmpFx[20]*tmpObjS[39] + tmpFx[26]*tmpObjS[50] + tmpFx[32]*tmpObjS[61] + tmpFx[38]*tmpObjS[72] + tmpFx[44]*tmpObjS[83] + tmpFx[50]*tmpObjS[94] + tmpFx[56]*tmpObjS[105] + tmpFx[62]*tmpObjS[116];
tmpQ2[29] = + tmpFx[2]*tmpObjS[7] + tmpFx[8]*tmpObjS[18] + tmpFx[14]*tmpObjS[29] + tmpFx[20]*tmpObjS[40] + tmpFx[26]*tmpObjS[51] + tmpFx[32]*tmpObjS[62] + tmpFx[38]*tmpObjS[73] + tmpFx[44]*tmpObjS[84] + tmpFx[50]*tmpObjS[95] + tmpFx[56]*tmpObjS[106] + tmpFx[62]*tmpObjS[117];
tmpQ2[30] = + tmpFx[2]*tmpObjS[8] + tmpFx[8]*tmpObjS[19] + tmpFx[14]*tmpObjS[30] + tmpFx[20]*tmpObjS[41] + tmpFx[26]*tmpObjS[52] + tmpFx[32]*tmpObjS[63] + tmpFx[38]*tmpObjS[74] + tmpFx[44]*tmpObjS[85] + tmpFx[50]*tmpObjS[96] + tmpFx[56]*tmpObjS[107] + tmpFx[62]*tmpObjS[118];
tmpQ2[31] = + tmpFx[2]*tmpObjS[9] + tmpFx[8]*tmpObjS[20] + tmpFx[14]*tmpObjS[31] + tmpFx[20]*tmpObjS[42] + tmpFx[26]*tmpObjS[53] + tmpFx[32]*tmpObjS[64] + tmpFx[38]*tmpObjS[75] + tmpFx[44]*tmpObjS[86] + tmpFx[50]*tmpObjS[97] + tmpFx[56]*tmpObjS[108] + tmpFx[62]*tmpObjS[119];
tmpQ2[32] = + tmpFx[2]*tmpObjS[10] + tmpFx[8]*tmpObjS[21] + tmpFx[14]*tmpObjS[32] + tmpFx[20]*tmpObjS[43] + tmpFx[26]*tmpObjS[54] + tmpFx[32]*tmpObjS[65] + tmpFx[38]*tmpObjS[76] + tmpFx[44]*tmpObjS[87] + tmpFx[50]*tmpObjS[98] + tmpFx[56]*tmpObjS[109] + tmpFx[62]*tmpObjS[120];
tmpQ2[33] = + tmpFx[3]*tmpObjS[0] + tmpFx[9]*tmpObjS[11] + tmpFx[15]*tmpObjS[22] + tmpFx[21]*tmpObjS[33] + tmpFx[27]*tmpObjS[44] + tmpFx[33]*tmpObjS[55] + tmpFx[39]*tmpObjS[66] + tmpFx[45]*tmpObjS[77] + tmpFx[51]*tmpObjS[88] + tmpFx[57]*tmpObjS[99] + tmpFx[63]*tmpObjS[110];
tmpQ2[34] = + tmpFx[3]*tmpObjS[1] + tmpFx[9]*tmpObjS[12] + tmpFx[15]*tmpObjS[23] + tmpFx[21]*tmpObjS[34] + tmpFx[27]*tmpObjS[45] + tmpFx[33]*tmpObjS[56] + tmpFx[39]*tmpObjS[67] + tmpFx[45]*tmpObjS[78] + tmpFx[51]*tmpObjS[89] + tmpFx[57]*tmpObjS[100] + tmpFx[63]*tmpObjS[111];
tmpQ2[35] = + tmpFx[3]*tmpObjS[2] + tmpFx[9]*tmpObjS[13] + tmpFx[15]*tmpObjS[24] + tmpFx[21]*tmpObjS[35] + tmpFx[27]*tmpObjS[46] + tmpFx[33]*tmpObjS[57] + tmpFx[39]*tmpObjS[68] + tmpFx[45]*tmpObjS[79] + tmpFx[51]*tmpObjS[90] + tmpFx[57]*tmpObjS[101] + tmpFx[63]*tmpObjS[112];
tmpQ2[36] = + tmpFx[3]*tmpObjS[3] + tmpFx[9]*tmpObjS[14] + tmpFx[15]*tmpObjS[25] + tmpFx[21]*tmpObjS[36] + tmpFx[27]*tmpObjS[47] + tmpFx[33]*tmpObjS[58] + tmpFx[39]*tmpObjS[69] + tmpFx[45]*tmpObjS[80] + tmpFx[51]*tmpObjS[91] + tmpFx[57]*tmpObjS[102] + tmpFx[63]*tmpObjS[113];
tmpQ2[37] = + tmpFx[3]*tmpObjS[4] + tmpFx[9]*tmpObjS[15] + tmpFx[15]*tmpObjS[26] + tmpFx[21]*tmpObjS[37] + tmpFx[27]*tmpObjS[48] + tmpFx[33]*tmpObjS[59] + tmpFx[39]*tmpObjS[70] + tmpFx[45]*tmpObjS[81] + tmpFx[51]*tmpObjS[92] + tmpFx[57]*tmpObjS[103] + tmpFx[63]*tmpObjS[114];
tmpQ2[38] = + tmpFx[3]*tmpObjS[5] + tmpFx[9]*tmpObjS[16] + tmpFx[15]*tmpObjS[27] + tmpFx[21]*tmpObjS[38] + tmpFx[27]*tmpObjS[49] + tmpFx[33]*tmpObjS[60] + tmpFx[39]*tmpObjS[71] + tmpFx[45]*tmpObjS[82] + tmpFx[51]*tmpObjS[93] + tmpFx[57]*tmpObjS[104] + tmpFx[63]*tmpObjS[115];
tmpQ2[39] = + tmpFx[3]*tmpObjS[6] + tmpFx[9]*tmpObjS[17] + tmpFx[15]*tmpObjS[28] + tmpFx[21]*tmpObjS[39] + tmpFx[27]*tmpObjS[50] + tmpFx[33]*tmpObjS[61] + tmpFx[39]*tmpObjS[72] + tmpFx[45]*tmpObjS[83] + tmpFx[51]*tmpObjS[94] + tmpFx[57]*tmpObjS[105] + tmpFx[63]*tmpObjS[116];
tmpQ2[40] = + tmpFx[3]*tmpObjS[7] + tmpFx[9]*tmpObjS[18] + tmpFx[15]*tmpObjS[29] + tmpFx[21]*tmpObjS[40] + tmpFx[27]*tmpObjS[51] + tmpFx[33]*tmpObjS[62] + tmpFx[39]*tmpObjS[73] + tmpFx[45]*tmpObjS[84] + tmpFx[51]*tmpObjS[95] + tmpFx[57]*tmpObjS[106] + tmpFx[63]*tmpObjS[117];
tmpQ2[41] = + tmpFx[3]*tmpObjS[8] + tmpFx[9]*tmpObjS[19] + tmpFx[15]*tmpObjS[30] + tmpFx[21]*tmpObjS[41] + tmpFx[27]*tmpObjS[52] + tmpFx[33]*tmpObjS[63] + tmpFx[39]*tmpObjS[74] + tmpFx[45]*tmpObjS[85] + tmpFx[51]*tmpObjS[96] + tmpFx[57]*tmpObjS[107] + tmpFx[63]*tmpObjS[118];
tmpQ2[42] = + tmpFx[3]*tmpObjS[9] + tmpFx[9]*tmpObjS[20] + tmpFx[15]*tmpObjS[31] + tmpFx[21]*tmpObjS[42] + tmpFx[27]*tmpObjS[53] + tmpFx[33]*tmpObjS[64] + tmpFx[39]*tmpObjS[75] + tmpFx[45]*tmpObjS[86] + tmpFx[51]*tmpObjS[97] + tmpFx[57]*tmpObjS[108] + tmpFx[63]*tmpObjS[119];
tmpQ2[43] = + tmpFx[3]*tmpObjS[10] + tmpFx[9]*tmpObjS[21] + tmpFx[15]*tmpObjS[32] + tmpFx[21]*tmpObjS[43] + tmpFx[27]*tmpObjS[54] + tmpFx[33]*tmpObjS[65] + tmpFx[39]*tmpObjS[76] + tmpFx[45]*tmpObjS[87] + tmpFx[51]*tmpObjS[98] + tmpFx[57]*tmpObjS[109] + tmpFx[63]*tmpObjS[120];
tmpQ2[44] = + tmpFx[4]*tmpObjS[0] + tmpFx[10]*tmpObjS[11] + tmpFx[16]*tmpObjS[22] + tmpFx[22]*tmpObjS[33] + tmpFx[28]*tmpObjS[44] + tmpFx[34]*tmpObjS[55] + tmpFx[40]*tmpObjS[66] + tmpFx[46]*tmpObjS[77] + tmpFx[52]*tmpObjS[88] + tmpFx[58]*tmpObjS[99] + tmpFx[64]*tmpObjS[110];
tmpQ2[45] = + tmpFx[4]*tmpObjS[1] + tmpFx[10]*tmpObjS[12] + tmpFx[16]*tmpObjS[23] + tmpFx[22]*tmpObjS[34] + tmpFx[28]*tmpObjS[45] + tmpFx[34]*tmpObjS[56] + tmpFx[40]*tmpObjS[67] + tmpFx[46]*tmpObjS[78] + tmpFx[52]*tmpObjS[89] + tmpFx[58]*tmpObjS[100] + tmpFx[64]*tmpObjS[111];
tmpQ2[46] = + tmpFx[4]*tmpObjS[2] + tmpFx[10]*tmpObjS[13] + tmpFx[16]*tmpObjS[24] + tmpFx[22]*tmpObjS[35] + tmpFx[28]*tmpObjS[46] + tmpFx[34]*tmpObjS[57] + tmpFx[40]*tmpObjS[68] + tmpFx[46]*tmpObjS[79] + tmpFx[52]*tmpObjS[90] + tmpFx[58]*tmpObjS[101] + tmpFx[64]*tmpObjS[112];
tmpQ2[47] = + tmpFx[4]*tmpObjS[3] + tmpFx[10]*tmpObjS[14] + tmpFx[16]*tmpObjS[25] + tmpFx[22]*tmpObjS[36] + tmpFx[28]*tmpObjS[47] + tmpFx[34]*tmpObjS[58] + tmpFx[40]*tmpObjS[69] + tmpFx[46]*tmpObjS[80] + tmpFx[52]*tmpObjS[91] + tmpFx[58]*tmpObjS[102] + tmpFx[64]*tmpObjS[113];
tmpQ2[48] = + tmpFx[4]*tmpObjS[4] + tmpFx[10]*tmpObjS[15] + tmpFx[16]*tmpObjS[26] + tmpFx[22]*tmpObjS[37] + tmpFx[28]*tmpObjS[48] + tmpFx[34]*tmpObjS[59] + tmpFx[40]*tmpObjS[70] + tmpFx[46]*tmpObjS[81] + tmpFx[52]*tmpObjS[92] + tmpFx[58]*tmpObjS[103] + tmpFx[64]*tmpObjS[114];
tmpQ2[49] = + tmpFx[4]*tmpObjS[5] + tmpFx[10]*tmpObjS[16] + tmpFx[16]*tmpObjS[27] + tmpFx[22]*tmpObjS[38] + tmpFx[28]*tmpObjS[49] + tmpFx[34]*tmpObjS[60] + tmpFx[40]*tmpObjS[71] + tmpFx[46]*tmpObjS[82] + tmpFx[52]*tmpObjS[93] + tmpFx[58]*tmpObjS[104] + tmpFx[64]*tmpObjS[115];
tmpQ2[50] = + tmpFx[4]*tmpObjS[6] + tmpFx[10]*tmpObjS[17] + tmpFx[16]*tmpObjS[28] + tmpFx[22]*tmpObjS[39] + tmpFx[28]*tmpObjS[50] + tmpFx[34]*tmpObjS[61] + tmpFx[40]*tmpObjS[72] + tmpFx[46]*tmpObjS[83] + tmpFx[52]*tmpObjS[94] + tmpFx[58]*tmpObjS[105] + tmpFx[64]*tmpObjS[116];
tmpQ2[51] = + tmpFx[4]*tmpObjS[7] + tmpFx[10]*tmpObjS[18] + tmpFx[16]*tmpObjS[29] + tmpFx[22]*tmpObjS[40] + tmpFx[28]*tmpObjS[51] + tmpFx[34]*tmpObjS[62] + tmpFx[40]*tmpObjS[73] + tmpFx[46]*tmpObjS[84] + tmpFx[52]*tmpObjS[95] + tmpFx[58]*tmpObjS[106] + tmpFx[64]*tmpObjS[117];
tmpQ2[52] = + tmpFx[4]*tmpObjS[8] + tmpFx[10]*tmpObjS[19] + tmpFx[16]*tmpObjS[30] + tmpFx[22]*tmpObjS[41] + tmpFx[28]*tmpObjS[52] + tmpFx[34]*tmpObjS[63] + tmpFx[40]*tmpObjS[74] + tmpFx[46]*tmpObjS[85] + tmpFx[52]*tmpObjS[96] + tmpFx[58]*tmpObjS[107] + tmpFx[64]*tmpObjS[118];
tmpQ2[53] = + tmpFx[4]*tmpObjS[9] + tmpFx[10]*tmpObjS[20] + tmpFx[16]*tmpObjS[31] + tmpFx[22]*tmpObjS[42] + tmpFx[28]*tmpObjS[53] + tmpFx[34]*tmpObjS[64] + tmpFx[40]*tmpObjS[75] + tmpFx[46]*tmpObjS[86] + tmpFx[52]*tmpObjS[97] + tmpFx[58]*tmpObjS[108] + tmpFx[64]*tmpObjS[119];
tmpQ2[54] = + tmpFx[4]*tmpObjS[10] + tmpFx[10]*tmpObjS[21] + tmpFx[16]*tmpObjS[32] + tmpFx[22]*tmpObjS[43] + tmpFx[28]*tmpObjS[54] + tmpFx[34]*tmpObjS[65] + tmpFx[40]*tmpObjS[76] + tmpFx[46]*tmpObjS[87] + tmpFx[52]*tmpObjS[98] + tmpFx[58]*tmpObjS[109] + tmpFx[64]*tmpObjS[120];
tmpQ2[55] = + tmpFx[5]*tmpObjS[0] + tmpFx[11]*tmpObjS[11] + tmpFx[17]*tmpObjS[22] + tmpFx[23]*tmpObjS[33] + tmpFx[29]*tmpObjS[44] + tmpFx[35]*tmpObjS[55] + tmpFx[41]*tmpObjS[66] + tmpFx[47]*tmpObjS[77] + tmpFx[53]*tmpObjS[88] + tmpFx[59]*tmpObjS[99] + tmpFx[65]*tmpObjS[110];
tmpQ2[56] = + tmpFx[5]*tmpObjS[1] + tmpFx[11]*tmpObjS[12] + tmpFx[17]*tmpObjS[23] + tmpFx[23]*tmpObjS[34] + tmpFx[29]*tmpObjS[45] + tmpFx[35]*tmpObjS[56] + tmpFx[41]*tmpObjS[67] + tmpFx[47]*tmpObjS[78] + tmpFx[53]*tmpObjS[89] + tmpFx[59]*tmpObjS[100] + tmpFx[65]*tmpObjS[111];
tmpQ2[57] = + tmpFx[5]*tmpObjS[2] + tmpFx[11]*tmpObjS[13] + tmpFx[17]*tmpObjS[24] + tmpFx[23]*tmpObjS[35] + tmpFx[29]*tmpObjS[46] + tmpFx[35]*tmpObjS[57] + tmpFx[41]*tmpObjS[68] + tmpFx[47]*tmpObjS[79] + tmpFx[53]*tmpObjS[90] + tmpFx[59]*tmpObjS[101] + tmpFx[65]*tmpObjS[112];
tmpQ2[58] = + tmpFx[5]*tmpObjS[3] + tmpFx[11]*tmpObjS[14] + tmpFx[17]*tmpObjS[25] + tmpFx[23]*tmpObjS[36] + tmpFx[29]*tmpObjS[47] + tmpFx[35]*tmpObjS[58] + tmpFx[41]*tmpObjS[69] + tmpFx[47]*tmpObjS[80] + tmpFx[53]*tmpObjS[91] + tmpFx[59]*tmpObjS[102] + tmpFx[65]*tmpObjS[113];
tmpQ2[59] = + tmpFx[5]*tmpObjS[4] + tmpFx[11]*tmpObjS[15] + tmpFx[17]*tmpObjS[26] + tmpFx[23]*tmpObjS[37] + tmpFx[29]*tmpObjS[48] + tmpFx[35]*tmpObjS[59] + tmpFx[41]*tmpObjS[70] + tmpFx[47]*tmpObjS[81] + tmpFx[53]*tmpObjS[92] + tmpFx[59]*tmpObjS[103] + tmpFx[65]*tmpObjS[114];
tmpQ2[60] = + tmpFx[5]*tmpObjS[5] + tmpFx[11]*tmpObjS[16] + tmpFx[17]*tmpObjS[27] + tmpFx[23]*tmpObjS[38] + tmpFx[29]*tmpObjS[49] + tmpFx[35]*tmpObjS[60] + tmpFx[41]*tmpObjS[71] + tmpFx[47]*tmpObjS[82] + tmpFx[53]*tmpObjS[93] + tmpFx[59]*tmpObjS[104] + tmpFx[65]*tmpObjS[115];
tmpQ2[61] = + tmpFx[5]*tmpObjS[6] + tmpFx[11]*tmpObjS[17] + tmpFx[17]*tmpObjS[28] + tmpFx[23]*tmpObjS[39] + tmpFx[29]*tmpObjS[50] + tmpFx[35]*tmpObjS[61] + tmpFx[41]*tmpObjS[72] + tmpFx[47]*tmpObjS[83] + tmpFx[53]*tmpObjS[94] + tmpFx[59]*tmpObjS[105] + tmpFx[65]*tmpObjS[116];
tmpQ2[62] = + tmpFx[5]*tmpObjS[7] + tmpFx[11]*tmpObjS[18] + tmpFx[17]*tmpObjS[29] + tmpFx[23]*tmpObjS[40] + tmpFx[29]*tmpObjS[51] + tmpFx[35]*tmpObjS[62] + tmpFx[41]*tmpObjS[73] + tmpFx[47]*tmpObjS[84] + tmpFx[53]*tmpObjS[95] + tmpFx[59]*tmpObjS[106] + tmpFx[65]*tmpObjS[117];
tmpQ2[63] = + tmpFx[5]*tmpObjS[8] + tmpFx[11]*tmpObjS[19] + tmpFx[17]*tmpObjS[30] + tmpFx[23]*tmpObjS[41] + tmpFx[29]*tmpObjS[52] + tmpFx[35]*tmpObjS[63] + tmpFx[41]*tmpObjS[74] + tmpFx[47]*tmpObjS[85] + tmpFx[53]*tmpObjS[96] + tmpFx[59]*tmpObjS[107] + tmpFx[65]*tmpObjS[118];
tmpQ2[64] = + tmpFx[5]*tmpObjS[9] + tmpFx[11]*tmpObjS[20] + tmpFx[17]*tmpObjS[31] + tmpFx[23]*tmpObjS[42] + tmpFx[29]*tmpObjS[53] + tmpFx[35]*tmpObjS[64] + tmpFx[41]*tmpObjS[75] + tmpFx[47]*tmpObjS[86] + tmpFx[53]*tmpObjS[97] + tmpFx[59]*tmpObjS[108] + tmpFx[65]*tmpObjS[119];
tmpQ2[65] = + tmpFx[5]*tmpObjS[10] + tmpFx[11]*tmpObjS[21] + tmpFx[17]*tmpObjS[32] + tmpFx[23]*tmpObjS[43] + tmpFx[29]*tmpObjS[54] + tmpFx[35]*tmpObjS[65] + tmpFx[41]*tmpObjS[76] + tmpFx[47]*tmpObjS[87] + tmpFx[53]*tmpObjS[98] + tmpFx[59]*tmpObjS[109] + tmpFx[65]*tmpObjS[120];
tmpQ1[0] = + tmpQ2[0]*tmpFx[0] + tmpQ2[1]*tmpFx[6] + tmpQ2[2]*tmpFx[12] + tmpQ2[3]*tmpFx[18] + tmpQ2[4]*tmpFx[24] + tmpQ2[5]*tmpFx[30] + tmpQ2[6]*tmpFx[36] + tmpQ2[7]*tmpFx[42] + tmpQ2[8]*tmpFx[48] + tmpQ2[9]*tmpFx[54] + tmpQ2[10]*tmpFx[60];
tmpQ1[1] = + tmpQ2[0]*tmpFx[1] + tmpQ2[1]*tmpFx[7] + tmpQ2[2]*tmpFx[13] + tmpQ2[3]*tmpFx[19] + tmpQ2[4]*tmpFx[25] + tmpQ2[5]*tmpFx[31] + tmpQ2[6]*tmpFx[37] + tmpQ2[7]*tmpFx[43] + tmpQ2[8]*tmpFx[49] + tmpQ2[9]*tmpFx[55] + tmpQ2[10]*tmpFx[61];
tmpQ1[2] = + tmpQ2[0]*tmpFx[2] + tmpQ2[1]*tmpFx[8] + tmpQ2[2]*tmpFx[14] + tmpQ2[3]*tmpFx[20] + tmpQ2[4]*tmpFx[26] + tmpQ2[5]*tmpFx[32] + tmpQ2[6]*tmpFx[38] + tmpQ2[7]*tmpFx[44] + tmpQ2[8]*tmpFx[50] + tmpQ2[9]*tmpFx[56] + tmpQ2[10]*tmpFx[62];
tmpQ1[3] = + tmpQ2[0]*tmpFx[3] + tmpQ2[1]*tmpFx[9] + tmpQ2[2]*tmpFx[15] + tmpQ2[3]*tmpFx[21] + tmpQ2[4]*tmpFx[27] + tmpQ2[5]*tmpFx[33] + tmpQ2[6]*tmpFx[39] + tmpQ2[7]*tmpFx[45] + tmpQ2[8]*tmpFx[51] + tmpQ2[9]*tmpFx[57] + tmpQ2[10]*tmpFx[63];
tmpQ1[4] = + tmpQ2[0]*tmpFx[4] + tmpQ2[1]*tmpFx[10] + tmpQ2[2]*tmpFx[16] + tmpQ2[3]*tmpFx[22] + tmpQ2[4]*tmpFx[28] + tmpQ2[5]*tmpFx[34] + tmpQ2[6]*tmpFx[40] + tmpQ2[7]*tmpFx[46] + tmpQ2[8]*tmpFx[52] + tmpQ2[9]*tmpFx[58] + tmpQ2[10]*tmpFx[64];
tmpQ1[5] = + tmpQ2[0]*tmpFx[5] + tmpQ2[1]*tmpFx[11] + tmpQ2[2]*tmpFx[17] + tmpQ2[3]*tmpFx[23] + tmpQ2[4]*tmpFx[29] + tmpQ2[5]*tmpFx[35] + tmpQ2[6]*tmpFx[41] + tmpQ2[7]*tmpFx[47] + tmpQ2[8]*tmpFx[53] + tmpQ2[9]*tmpFx[59] + tmpQ2[10]*tmpFx[65];
tmpQ1[6] = + tmpQ2[11]*tmpFx[0] + tmpQ2[12]*tmpFx[6] + tmpQ2[13]*tmpFx[12] + tmpQ2[14]*tmpFx[18] + tmpQ2[15]*tmpFx[24] + tmpQ2[16]*tmpFx[30] + tmpQ2[17]*tmpFx[36] + tmpQ2[18]*tmpFx[42] + tmpQ2[19]*tmpFx[48] + tmpQ2[20]*tmpFx[54] + tmpQ2[21]*tmpFx[60];
tmpQ1[7] = + tmpQ2[11]*tmpFx[1] + tmpQ2[12]*tmpFx[7] + tmpQ2[13]*tmpFx[13] + tmpQ2[14]*tmpFx[19] + tmpQ2[15]*tmpFx[25] + tmpQ2[16]*tmpFx[31] + tmpQ2[17]*tmpFx[37] + tmpQ2[18]*tmpFx[43] + tmpQ2[19]*tmpFx[49] + tmpQ2[20]*tmpFx[55] + tmpQ2[21]*tmpFx[61];
tmpQ1[8] = + tmpQ2[11]*tmpFx[2] + tmpQ2[12]*tmpFx[8] + tmpQ2[13]*tmpFx[14] + tmpQ2[14]*tmpFx[20] + tmpQ2[15]*tmpFx[26] + tmpQ2[16]*tmpFx[32] + tmpQ2[17]*tmpFx[38] + tmpQ2[18]*tmpFx[44] + tmpQ2[19]*tmpFx[50] + tmpQ2[20]*tmpFx[56] + tmpQ2[21]*tmpFx[62];
tmpQ1[9] = + tmpQ2[11]*tmpFx[3] + tmpQ2[12]*tmpFx[9] + tmpQ2[13]*tmpFx[15] + tmpQ2[14]*tmpFx[21] + tmpQ2[15]*tmpFx[27] + tmpQ2[16]*tmpFx[33] + tmpQ2[17]*tmpFx[39] + tmpQ2[18]*tmpFx[45] + tmpQ2[19]*tmpFx[51] + tmpQ2[20]*tmpFx[57] + tmpQ2[21]*tmpFx[63];
tmpQ1[10] = + tmpQ2[11]*tmpFx[4] + tmpQ2[12]*tmpFx[10] + tmpQ2[13]*tmpFx[16] + tmpQ2[14]*tmpFx[22] + tmpQ2[15]*tmpFx[28] + tmpQ2[16]*tmpFx[34] + tmpQ2[17]*tmpFx[40] + tmpQ2[18]*tmpFx[46] + tmpQ2[19]*tmpFx[52] + tmpQ2[20]*tmpFx[58] + tmpQ2[21]*tmpFx[64];
tmpQ1[11] = + tmpQ2[11]*tmpFx[5] + tmpQ2[12]*tmpFx[11] + tmpQ2[13]*tmpFx[17] + tmpQ2[14]*tmpFx[23] + tmpQ2[15]*tmpFx[29] + tmpQ2[16]*tmpFx[35] + tmpQ2[17]*tmpFx[41] + tmpQ2[18]*tmpFx[47] + tmpQ2[19]*tmpFx[53] + tmpQ2[20]*tmpFx[59] + tmpQ2[21]*tmpFx[65];
tmpQ1[12] = + tmpQ2[22]*tmpFx[0] + tmpQ2[23]*tmpFx[6] + tmpQ2[24]*tmpFx[12] + tmpQ2[25]*tmpFx[18] + tmpQ2[26]*tmpFx[24] + tmpQ2[27]*tmpFx[30] + tmpQ2[28]*tmpFx[36] + tmpQ2[29]*tmpFx[42] + tmpQ2[30]*tmpFx[48] + tmpQ2[31]*tmpFx[54] + tmpQ2[32]*tmpFx[60];
tmpQ1[13] = + tmpQ2[22]*tmpFx[1] + tmpQ2[23]*tmpFx[7] + tmpQ2[24]*tmpFx[13] + tmpQ2[25]*tmpFx[19] + tmpQ2[26]*tmpFx[25] + tmpQ2[27]*tmpFx[31] + tmpQ2[28]*tmpFx[37] + tmpQ2[29]*tmpFx[43] + tmpQ2[30]*tmpFx[49] + tmpQ2[31]*tmpFx[55] + tmpQ2[32]*tmpFx[61];
tmpQ1[14] = + tmpQ2[22]*tmpFx[2] + tmpQ2[23]*tmpFx[8] + tmpQ2[24]*tmpFx[14] + tmpQ2[25]*tmpFx[20] + tmpQ2[26]*tmpFx[26] + tmpQ2[27]*tmpFx[32] + tmpQ2[28]*tmpFx[38] + tmpQ2[29]*tmpFx[44] + tmpQ2[30]*tmpFx[50] + tmpQ2[31]*tmpFx[56] + tmpQ2[32]*tmpFx[62];
tmpQ1[15] = + tmpQ2[22]*tmpFx[3] + tmpQ2[23]*tmpFx[9] + tmpQ2[24]*tmpFx[15] + tmpQ2[25]*tmpFx[21] + tmpQ2[26]*tmpFx[27] + tmpQ2[27]*tmpFx[33] + tmpQ2[28]*tmpFx[39] + tmpQ2[29]*tmpFx[45] + tmpQ2[30]*tmpFx[51] + tmpQ2[31]*tmpFx[57] + tmpQ2[32]*tmpFx[63];
tmpQ1[16] = + tmpQ2[22]*tmpFx[4] + tmpQ2[23]*tmpFx[10] + tmpQ2[24]*tmpFx[16] + tmpQ2[25]*tmpFx[22] + tmpQ2[26]*tmpFx[28] + tmpQ2[27]*tmpFx[34] + tmpQ2[28]*tmpFx[40] + tmpQ2[29]*tmpFx[46] + tmpQ2[30]*tmpFx[52] + tmpQ2[31]*tmpFx[58] + tmpQ2[32]*tmpFx[64];
tmpQ1[17] = + tmpQ2[22]*tmpFx[5] + tmpQ2[23]*tmpFx[11] + tmpQ2[24]*tmpFx[17] + tmpQ2[25]*tmpFx[23] + tmpQ2[26]*tmpFx[29] + tmpQ2[27]*tmpFx[35] + tmpQ2[28]*tmpFx[41] + tmpQ2[29]*tmpFx[47] + tmpQ2[30]*tmpFx[53] + tmpQ2[31]*tmpFx[59] + tmpQ2[32]*tmpFx[65];
tmpQ1[18] = + tmpQ2[33]*tmpFx[0] + tmpQ2[34]*tmpFx[6] + tmpQ2[35]*tmpFx[12] + tmpQ2[36]*tmpFx[18] + tmpQ2[37]*tmpFx[24] + tmpQ2[38]*tmpFx[30] + tmpQ2[39]*tmpFx[36] + tmpQ2[40]*tmpFx[42] + tmpQ2[41]*tmpFx[48] + tmpQ2[42]*tmpFx[54] + tmpQ2[43]*tmpFx[60];
tmpQ1[19] = + tmpQ2[33]*tmpFx[1] + tmpQ2[34]*tmpFx[7] + tmpQ2[35]*tmpFx[13] + tmpQ2[36]*tmpFx[19] + tmpQ2[37]*tmpFx[25] + tmpQ2[38]*tmpFx[31] + tmpQ2[39]*tmpFx[37] + tmpQ2[40]*tmpFx[43] + tmpQ2[41]*tmpFx[49] + tmpQ2[42]*tmpFx[55] + tmpQ2[43]*tmpFx[61];
tmpQ1[20] = + tmpQ2[33]*tmpFx[2] + tmpQ2[34]*tmpFx[8] + tmpQ2[35]*tmpFx[14] + tmpQ2[36]*tmpFx[20] + tmpQ2[37]*tmpFx[26] + tmpQ2[38]*tmpFx[32] + tmpQ2[39]*tmpFx[38] + tmpQ2[40]*tmpFx[44] + tmpQ2[41]*tmpFx[50] + tmpQ2[42]*tmpFx[56] + tmpQ2[43]*tmpFx[62];
tmpQ1[21] = + tmpQ2[33]*tmpFx[3] + tmpQ2[34]*tmpFx[9] + tmpQ2[35]*tmpFx[15] + tmpQ2[36]*tmpFx[21] + tmpQ2[37]*tmpFx[27] + tmpQ2[38]*tmpFx[33] + tmpQ2[39]*tmpFx[39] + tmpQ2[40]*tmpFx[45] + tmpQ2[41]*tmpFx[51] + tmpQ2[42]*tmpFx[57] + tmpQ2[43]*tmpFx[63];
tmpQ1[22] = + tmpQ2[33]*tmpFx[4] + tmpQ2[34]*tmpFx[10] + tmpQ2[35]*tmpFx[16] + tmpQ2[36]*tmpFx[22] + tmpQ2[37]*tmpFx[28] + tmpQ2[38]*tmpFx[34] + tmpQ2[39]*tmpFx[40] + tmpQ2[40]*tmpFx[46] + tmpQ2[41]*tmpFx[52] + tmpQ2[42]*tmpFx[58] + tmpQ2[43]*tmpFx[64];
tmpQ1[23] = + tmpQ2[33]*tmpFx[5] + tmpQ2[34]*tmpFx[11] + tmpQ2[35]*tmpFx[17] + tmpQ2[36]*tmpFx[23] + tmpQ2[37]*tmpFx[29] + tmpQ2[38]*tmpFx[35] + tmpQ2[39]*tmpFx[41] + tmpQ2[40]*tmpFx[47] + tmpQ2[41]*tmpFx[53] + tmpQ2[42]*tmpFx[59] + tmpQ2[43]*tmpFx[65];
tmpQ1[24] = + tmpQ2[44]*tmpFx[0] + tmpQ2[45]*tmpFx[6] + tmpQ2[46]*tmpFx[12] + tmpQ2[47]*tmpFx[18] + tmpQ2[48]*tmpFx[24] + tmpQ2[49]*tmpFx[30] + tmpQ2[50]*tmpFx[36] + tmpQ2[51]*tmpFx[42] + tmpQ2[52]*tmpFx[48] + tmpQ2[53]*tmpFx[54] + tmpQ2[54]*tmpFx[60];
tmpQ1[25] = + tmpQ2[44]*tmpFx[1] + tmpQ2[45]*tmpFx[7] + tmpQ2[46]*tmpFx[13] + tmpQ2[47]*tmpFx[19] + tmpQ2[48]*tmpFx[25] + tmpQ2[49]*tmpFx[31] + tmpQ2[50]*tmpFx[37] + tmpQ2[51]*tmpFx[43] + tmpQ2[52]*tmpFx[49] + tmpQ2[53]*tmpFx[55] + tmpQ2[54]*tmpFx[61];
tmpQ1[26] = + tmpQ2[44]*tmpFx[2] + tmpQ2[45]*tmpFx[8] + tmpQ2[46]*tmpFx[14] + tmpQ2[47]*tmpFx[20] + tmpQ2[48]*tmpFx[26] + tmpQ2[49]*tmpFx[32] + tmpQ2[50]*tmpFx[38] + tmpQ2[51]*tmpFx[44] + tmpQ2[52]*tmpFx[50] + tmpQ2[53]*tmpFx[56] + tmpQ2[54]*tmpFx[62];
tmpQ1[27] = + tmpQ2[44]*tmpFx[3] + tmpQ2[45]*tmpFx[9] + tmpQ2[46]*tmpFx[15] + tmpQ2[47]*tmpFx[21] + tmpQ2[48]*tmpFx[27] + tmpQ2[49]*tmpFx[33] + tmpQ2[50]*tmpFx[39] + tmpQ2[51]*tmpFx[45] + tmpQ2[52]*tmpFx[51] + tmpQ2[53]*tmpFx[57] + tmpQ2[54]*tmpFx[63];
tmpQ1[28] = + tmpQ2[44]*tmpFx[4] + tmpQ2[45]*tmpFx[10] + tmpQ2[46]*tmpFx[16] + tmpQ2[47]*tmpFx[22] + tmpQ2[48]*tmpFx[28] + tmpQ2[49]*tmpFx[34] + tmpQ2[50]*tmpFx[40] + tmpQ2[51]*tmpFx[46] + tmpQ2[52]*tmpFx[52] + tmpQ2[53]*tmpFx[58] + tmpQ2[54]*tmpFx[64];
tmpQ1[29] = + tmpQ2[44]*tmpFx[5] + tmpQ2[45]*tmpFx[11] + tmpQ2[46]*tmpFx[17] + tmpQ2[47]*tmpFx[23] + tmpQ2[48]*tmpFx[29] + tmpQ2[49]*tmpFx[35] + tmpQ2[50]*tmpFx[41] + tmpQ2[51]*tmpFx[47] + tmpQ2[52]*tmpFx[53] + tmpQ2[53]*tmpFx[59] + tmpQ2[54]*tmpFx[65];
tmpQ1[30] = + tmpQ2[55]*tmpFx[0] + tmpQ2[56]*tmpFx[6] + tmpQ2[57]*tmpFx[12] + tmpQ2[58]*tmpFx[18] + tmpQ2[59]*tmpFx[24] + tmpQ2[60]*tmpFx[30] + tmpQ2[61]*tmpFx[36] + tmpQ2[62]*tmpFx[42] + tmpQ2[63]*tmpFx[48] + tmpQ2[64]*tmpFx[54] + tmpQ2[65]*tmpFx[60];
tmpQ1[31] = + tmpQ2[55]*tmpFx[1] + tmpQ2[56]*tmpFx[7] + tmpQ2[57]*tmpFx[13] + tmpQ2[58]*tmpFx[19] + tmpQ2[59]*tmpFx[25] + tmpQ2[60]*tmpFx[31] + tmpQ2[61]*tmpFx[37] + tmpQ2[62]*tmpFx[43] + tmpQ2[63]*tmpFx[49] + tmpQ2[64]*tmpFx[55] + tmpQ2[65]*tmpFx[61];
tmpQ1[32] = + tmpQ2[55]*tmpFx[2] + tmpQ2[56]*tmpFx[8] + tmpQ2[57]*tmpFx[14] + tmpQ2[58]*tmpFx[20] + tmpQ2[59]*tmpFx[26] + tmpQ2[60]*tmpFx[32] + tmpQ2[61]*tmpFx[38] + tmpQ2[62]*tmpFx[44] + tmpQ2[63]*tmpFx[50] + tmpQ2[64]*tmpFx[56] + tmpQ2[65]*tmpFx[62];
tmpQ1[33] = + tmpQ2[55]*tmpFx[3] + tmpQ2[56]*tmpFx[9] + tmpQ2[57]*tmpFx[15] + tmpQ2[58]*tmpFx[21] + tmpQ2[59]*tmpFx[27] + tmpQ2[60]*tmpFx[33] + tmpQ2[61]*tmpFx[39] + tmpQ2[62]*tmpFx[45] + tmpQ2[63]*tmpFx[51] + tmpQ2[64]*tmpFx[57] + tmpQ2[65]*tmpFx[63];
tmpQ1[34] = + tmpQ2[55]*tmpFx[4] + tmpQ2[56]*tmpFx[10] + tmpQ2[57]*tmpFx[16] + tmpQ2[58]*tmpFx[22] + tmpQ2[59]*tmpFx[28] + tmpQ2[60]*tmpFx[34] + tmpQ2[61]*tmpFx[40] + tmpQ2[62]*tmpFx[46] + tmpQ2[63]*tmpFx[52] + tmpQ2[64]*tmpFx[58] + tmpQ2[65]*tmpFx[64];
tmpQ1[35] = + tmpQ2[55]*tmpFx[5] + tmpQ2[56]*tmpFx[11] + tmpQ2[57]*tmpFx[17] + tmpQ2[58]*tmpFx[23] + tmpQ2[59]*tmpFx[29] + tmpQ2[60]*tmpFx[35] + tmpQ2[61]*tmpFx[41] + tmpQ2[62]*tmpFx[47] + tmpQ2[63]*tmpFx[53] + tmpQ2[64]*tmpFx[59] + tmpQ2[65]*tmpFx[65];
}
...
nmpc_setObjQ1Q2( &(nmpcWorkspace.objValueOut[ 11 ]), nmpcVariables.W, &(nmpcWorkspace.Q1[ runObj * 36 ]), &(nmpcWorkspace.Q2[ runObj * 66 ]) );

nmpc_setObjR1R2( &(nmpcWorkspace.objValueOut[ 77 ]), nmpcVariables.W, &(nmpcWorkspace.R1[ runObj * 16 ]), &(nmpcWorkspace.R2[ runObj * 44 ]) );
...
nmpc_multRDy( &(nmpcWorkspace.R2[ 44 ]), &(nmpcWorkspace.Dy[ 11 ]), &(nmpcWorkspace.g[ 10 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 88 ]), &(nmpcWorkspace.Dy[ 22 ]), &(nmpcWorkspace.g[ 14 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 132 ]), &(nmpcWorkspace.Dy[ 33 ]), &(nmpcWorkspace.g[ 18 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 176 ]), &(nmpcWorkspace.Dy[ 44 ]), &(nmpcWorkspace.g[ 22 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 220 ]), &(nmpcWorkspace.Dy[ 55 ]), &(nmpcWorkspace.g[ 26 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 264 ]), &(nmpcWorkspace.Dy[ 66 ]), &(nmpcWorkspace.g[ 30 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 308 ]), &(nmpcWorkspace.Dy[ 77 ]), &(nmpcWorkspace.g[ 34 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 352 ]), &(nmpcWorkspace.Dy[ 88 ]), &(nmpcWorkspace.g[ 38 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 396 ]), &(nmpcWorkspace.Dy[ 99 ]), &(nmpcWorkspace.g[ 42 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 440 ]), &(nmpcWorkspace.Dy[ 110 ]), &(nmpcWorkspace.g[ 46 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 484 ]), &(nmpcWorkspace.Dy[ 121 ]), &(nmpcWorkspace.g[ 50 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 528 ]), &(nmpcWorkspace.Dy[ 132 ]), &(nmpcWorkspace.g[ 54 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 572 ]), &(nmpcWorkspace.Dy[ 143 ]), &(nmpcWorkspace.g[ 58 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 616 ]), &(nmpcWorkspace.Dy[ 154 ]), &(nmpcWorkspace.g[ 62 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 660 ]), &(nmpcWorkspace.Dy[ 165 ]), &(nmpcWorkspace.g[ 66 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 704 ]), &(nmpcWorkspace.Dy[ 176 ]), &(nmpcWorkspace.g[ 70 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 748 ]), &(nmpcWorkspace.Dy[ 187 ]), &(nmpcWorkspace.g[ 74 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 792 ]), &(nmpcWorkspace.Dy[ 198 ]), &(nmpcWorkspace.g[ 78 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 836 ]), &(nmpcWorkspace.Dy[ 209 ]), &(nmpcWorkspace.g[ 82 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 880 ]), &(nmpcWorkspace.Dy[ 220 ]), &(nmpcWorkspace.g[ 86 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 924 ]), &(nmpcWorkspace.Dy[ 231 ]), &(nmpcWorkspace.g[ 90 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 968 ]), &(nmpcWorkspace.Dy[ 242 ]), &(nmpcWorkspace.g[ 94 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 1012 ]), &(nmpcWorkspace.Dy[ 253 ]), &(nmpcWorkspace.g[ 98 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 1056 ]), &(nmpcWorkspace.Dy[ 264 ]), &(nmpcWorkspace.g[ 102 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 1100 ]), &(nmpcWorkspace.Dy[ 275 ]), &(nmpcWorkspace.g[ 106 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 1144 ]), &(nmpcWorkspace.Dy[ 286 ]), &(nmpcWorkspace.g[ 110 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 1188 ]), &(nmpcWorkspace.Dy[ 297 ]), &(nmpcWorkspace.g[ 114 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 1232 ]), &(nmpcWorkspace.Dy[ 308 ]), &(nmpcWorkspace.g[ 118 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 1276 ]), &(nmpcWorkspace.Dy[ 319 ]), &(nmpcWorkspace.g[ 122 ]) );

nmpc_multQDy( nmpcWorkspace.Q2, nmpcWorkspace.Dy, nmpcWorkspace.QDy );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 66 ]), &(nmpcWorkspace.Dy[ 11 ]), &(nmpcWorkspace.QDy[ 6 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 132 ]), &(nmpcWorkspace.Dy[ 22 ]), &(nmpcWorkspace.QDy[ 12 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 198 ]), &(nmpcWorkspace.Dy[ 33 ]), &(nmpcWorkspace.QDy[ 18 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 264 ]), &(nmpcWorkspace.Dy[ 44 ]), &(nmpcWorkspace.QDy[ 24 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 330 ]), &(nmpcWorkspace.Dy[ 55 ]), &(nmpcWorkspace.QDy[ 30 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 396 ]), &(nmpcWorkspace.Dy[ 66 ]), &(nmpcWorkspace.QDy[ 36 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 462 ]), &(nmpcWorkspace.Dy[ 77 ]), &(nmpcWorkspace.QDy[ 42 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 528 ]), &(nmpcWorkspace.Dy[ 88 ]), &(nmpcWorkspace.QDy[ 48 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 594 ]), &(nmpcWorkspace.Dy[ 99 ]), &(nmpcWorkspace.QDy[ 54 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 660 ]), &(nmpcWorkspace.Dy[ 110 ]), &(nmpcWorkspace.QDy[ 60 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 726 ]), &(nmpcWorkspace.Dy[ 121 ]), &(nmpcWorkspace.QDy[ 66 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 792 ]), &(nmpcWorkspace.Dy[ 132 ]), &(nmpcWorkspace.QDy[ 72 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 858 ]), &(nmpcWorkspace.Dy[ 143 ]), &(nmpcWorkspace.QDy[ 78 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 924 ]), &(nmpcWorkspace.Dy[ 154 ]), &(nmpcWorkspace.QDy[ 84 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 990 ]), &(nmpcWorkspace.Dy[ 165 ]), &(nmpcWorkspace.QDy[ 90 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1056 ]), &(nmpcWorkspace.Dy[ 176 ]), &(nmpcWorkspace.QDy[ 96 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1122 ]), &(nmpcWorkspace.Dy[ 187 ]), &(nmpcWorkspace.QDy[ 102 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1188 ]), &(nmpcWorkspace.Dy[ 198 ]), &(nmpcWorkspace.QDy[ 108 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1254 ]), &(nmpcWorkspace.Dy[ 209 ]), &(nmpcWorkspace.QDy[ 114 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1320 ]), &(nmpcWorkspace.Dy[ 220 ]), &(nmpcWorkspace.QDy[ 120 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1386 ]), &(nmpcWorkspace.Dy[ 231 ]), &(nmpcWorkspace.QDy[ 126 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1452 ]), &(nmpcWorkspace.Dy[ 242 ]), &(nmpcWorkspace.QDy[ 132 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1518 ]), &(nmpcWorkspace.Dy[ 253 ]), &(nmpcWorkspace.QDy[ 138 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1584 ]), &(nmpcWorkspace.Dy[ 264 ]), &(nmpcWorkspace.QDy[ 144 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1650 ]), &(nmpcWorkspace.Dy[ 275 ]), &(nmpcWorkspace.QDy[ 150 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1716 ]), &(nmpcWorkspace.Dy[ 286 ]), &(nmpcWorkspace.QDy[ 156 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1782 ]), &(nmpcWorkspace.Dy[ 297 ]), &(nmpcWorkspace.QDy[ 162 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1848 ]), &(nmpcWorkspace.Dy[ 308 ]), &(nmpcWorkspace.QDy[ 168 ]) );
nmpc_multQDy( &(nmpcWorkspace.Q2[ 1914 ]), &(nmpcWorkspace.Dy[ 319 ]), &(nmpcWorkspace.QDy[ 174 ]) );

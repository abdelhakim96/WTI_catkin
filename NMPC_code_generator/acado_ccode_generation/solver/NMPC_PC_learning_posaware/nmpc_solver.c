...
a[8] = (1.0/sqrt((((a[0]*a[0])+(a[1]*a[1]))+(a[2]*a[2]))));
a[9] = (a[8]*(real_t)(5.0000000000000000e-01));
a[10] = (((a[7]*a[0])+(a[0]*a[7]))*a[9]);
a[11] = ((real_t)(1.0000000000000000e+00)/a[3]);
a[12] = (a[11]*a[11]);
a[13] = ((((real_t)(0.0000000000000000e+00)-(a[10]*a[12]))*((a[4]*a[0])+(a[5]*a[1])))+(((real_t)(1.0000000000000000e+00)/a[3])*(a[4]*a[7])));
a[14] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
a[15] = (((a[14]*a[1])+(a[1]*a[14]))*a[9]);
a[16] = ((((real_t)(0.0000000000000000e+00)-(a[15]*a[12]))*((a[4]*a[0])+(a[5]*a[1])))+(((real_t)(1.0000000000000000e+00)/a[3])*(a[5]*a[14])));
a[17] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
a[18] = (((a[17]*a[2])+(a[2]*a[17]))*a[9]);
a[19] = (((real_t)(0.0000000000000000e+00)-(a[18]*a[12]))*((a[4]*a[0])+(a[5]*a[1])));
...
a[28] = ((real_t)(-1.0000000000000000e+00)*(sin(u[2])));
a[29] = (cos(u[2]));
a[30] = (((real_t)(1.0000000000000000e+00)/a[3])*((a[28]*a[0])+(a[29]*a[1])));

...
a[51] = ((real_t)(-1.0000000000000000e+00)*(sin(u[2])));
a[52] = (cos(u[2]));
a[53] = (((real_t)(1.0000000000000000e+00)/a[4])*((a[51]*a[0])+(a[52]*a[1])));
a[54] = (real_t)(0.0000000000000000e+00);
a[55] = (real_t)(0.0000000000000000e+00);
a[56] = (real_t)(0.0000000000000000e+00);
a[57] = (cos(u[2]));
a[58] = ((real_t)(-1.0000000000000000e+00)*(sin(u[2])));
a[59] = ((real_t)(-1.0000000000000000e+00)*(sin(u[2])));
a[60] = (cos(u[2]));
a[61] = (((real_t)(1.0000000000000000e+00)/a[4])*(((((((real_t)(0.0000000000000000e+00)-a[57])*od[2])*a[0])+(a[58]*((real_t)(0.0000000000000000e+00)-xd[3])))+((a[59]*od[2])*a[1]))+(a[60]*((real_t)(0.0000000000000000e+00)-xd[4]))));

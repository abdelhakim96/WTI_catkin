...
a[58] = ((real_t)(1.0000000000000000e+00)/a[7]);
a[59] = (((a[57]*a[0])+(a[0]*a[57]))*a[38]);
a[60] = (a[58]*a[58]);
a[61] = (((od[6]*a[57])*a[58])-((((od[6]*a[0])+(od[7]*a[1]))*a[59])*a[60]));
a[62] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
a[63] = (((a[62]*a[1])+(a[1]*a[62]))*a[38]);
a[64] = (((od[7]*a[62])*a[58])-((((od[6]*a[0])+(od[7]*a[1]))*a[63])*a[60]));
a[65] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
a[66] = (((a[65]*a[5])+(a[5]*a[65]))*a[38]);
a[67] = ((real_t)(0.0000000000000000e+00)-((((od[6]*a[0])+(od[7]*a[1]))*a[66])*a[60]));
...
a[82] = (a[81]-((a[81]*od[6])*od[6]));
a[83] = ((real_t)(0.0000000000000000e+00)-((a[81]*od[6])*od[7]));
a[84] = (1.0/sqrt((((a[9]*a[9])+(a[10]*a[10]))+(a[5]*a[5]))));
a[85] = (a[84]*(real_t)(5.0000000000000000e-01));
a[86] = ((((a[82]*a[9])+(a[9]*a[82]))+((a[83]*a[10])+(a[10]*a[83])))*a[85]);
a[87] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
a[88] = ((real_t)(0.0000000000000000e+00)-((a[87]*od[7])*od[6]));
a[89] = (a[87]-((a[87]*od[7])*od[7]));
a[90] = ((((a[88]*a[9])+(a[9]*a[88]))+((a[89]*a[10])+(a[10]*a[89])))*a[85]);
a[91] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
a[92] = (((a[91]*a[5])+(a[5]*a[91]))*a[85]);

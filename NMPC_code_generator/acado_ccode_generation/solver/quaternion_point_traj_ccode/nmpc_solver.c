...
/* Vector of auxiliary variables; number of elements: 115. */
...
a[78] = (1.0/sqrt(((a[9]*a[9])+(a[10]*a[10]))));
...
/* Vector of auxiliary variables; number of elements: 99. */
real_t* a = nmpcWorkspace.objAuxVar;

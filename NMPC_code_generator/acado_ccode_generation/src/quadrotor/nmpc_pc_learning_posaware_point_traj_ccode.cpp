...
int main()
{
    ...
    OnlineData ax;  // x-position of the inspection point
    OnlineData ay;  // y-position of the inspection point
    ...
    std::string path_dir = path + "/solver/NMPC_PC_learning_posaware_point_traj";

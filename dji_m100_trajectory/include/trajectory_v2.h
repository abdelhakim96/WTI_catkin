...
double max_z, x_hover, y_hover, z_hover, yaw_hover, wall_dist, x_sp_start, y_sp_start, z_sp_start, x_sp_end, y_sp_end, z_sp_end, length, height, z_interval_dist, z_interval_dist_updated, del_z, radius, absvel, rotvel, time_period, climb_rate, land_rate;
int pos_pub_delay, traj_type, camera_V_FOV, req_V_overlap_percent, num_turns, sp_z_counter, const_z;
bool traj_on, max_z_on, lidar_on, adaptive_yaw_on, reg_on, climb_flag, land_flag, change_z, pub_setpoint_pos, use_current_pos;
